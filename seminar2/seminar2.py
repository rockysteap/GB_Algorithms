...
# Мой запуск при 10 млн.:
"""
------------------- Сортировка пузырьком -------------------
Кол-во элементов 10,000
Выполнение за 4.118902206420898 сек.
-------------------- Быстрая сортировка --------------------
Кол-во элементов 10,000,000
Выполнение за 68.39274787902832 сек.
------ Быстрая сортировка (вариант из stack overflow) ------
Кол-во элементов 10,000,000
Выполнение за 31.692124366760254 сек.
--------------- Встроенная сортировка Python ---------------
Кол-во элементов 10,000,000
Выполнение за 2.999147891998291 сек.
------------------- Сортировка подсчетом -------------------
Кол-во элементов 10,000,000
Выполнение за 0.894202709197998 сек.
--------------- Бинарный поиск (с рекурсией) ---------------
Кол-во элементов 10,000,000
Искомое число 0 найдено по индексу [5000952].
Выполнение за 0.0 сек.
